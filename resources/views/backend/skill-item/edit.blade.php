    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
            ...
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0">Yetenek Düzenle</h3>
            </div>
            <!--end::Card title-->
        </div>
        <!--begin::Card header-->
        ...
        <div id="kt_account_profile_details" class="collapse show">
            <!--begin::Form-->
            <form action="{{ route("admin.skills-items.update", $skillItem->id) }}" method="POST" class="form fv-plugins-bootstrap5 fv-plugins-framework">
                @csrf
                @method('PUT')
                <!--begin::Card body-->
                    ...
                    <div class="row mb-6 offset-1">
                        ...
                        <div class="col-lg-8 fv-row fv-plugins-icon-container">
                            <input type="text"
                                   ...
                                   value="{{ old("name", isset($skillItem) ? $skillItem->name : "") }}"
                            >
                    ...
                    <div class="row mb-6 offset-1">
                        ...
                        <div class="col-lg-8 fv-row fv-plugins-icon-container">
                            <input type="number"
                                   ...
                                   value="{{ old("percent", isset($skillItem) ? $skillItem->percent : "") }}"
                            >
                            <div class="fv-plugins-message-container invalid-feedback"></div>
                        </div>
                        <!--end::Col-->
                    ...
                    <div class="row mb-6 offset-1">
                        ...
                        <div class="col-lg-1 fv-row fv-plugins-icon-container">
                            <input type="color"
                                   ...
                                   value="{{ old("color", isset($skillItem) ? $skillItem->color : "") }}"
                            >
                            <div class="fv-plugins-message-container invalid-feedback"></div>
                        </div>
                        <!--end::Col-->
