    ...
    <div class="card mb-5 mb-xl-10">
        ...
        <div class="card-header border-0 cursor-pointer" role="button" data-bs-toggle="collapse"
            ...
            <div class="card-title m-0">
                <h3 class="fw-bolder m-0">Blog Bölüm Ayarları</h3>
            </div>
            <!--end::Card title-->
        </div>
        <!--begin::Card header-->
        ...
        <div id="kt_account_profile_details" class="collapse show">
            <!--begin::Form-->
            <form action="{{ route("admin.blog-section-settings.update", 1) }}" method="POST" class="form fv-plugins-bootstrap5 fv-plugins-framework">
                @csrf
                @method('PUT')
                <!--begin::Card body-->
                <div class="card-body border-top p-9">
                    ...
                    <div class="row mb-6">
                        ...
                        <div class="col-lg-10 fv-row fv-plugins-icon-container">
                            <input type="text"
                                   ...
                                   value="{{ old("title", isset($blogSettings) ? $blogSettings->title : "") }}"
                            >
                    ...
                    <div class="row mb-6">
                        ...
                        <!--begin::Col-->
                        <div class="col-lg-10 fv-row fv-plugins-icon-container">
                            <textarea name="sub_title" id="sub_title">{!! old("sub_title", isset($blogSettings) ? $blogSettings->sub_title : "") !!}</textarea>
                            <div class="fv-plugins-message-container invalid-feedback"></div>
                        </div>
                        <!--end::Col-->
                    </div>
