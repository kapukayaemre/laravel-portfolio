...
@section("content")
    <div class="card mb-5 mb-xl-10">
        ...
        <div id="kt_account_profile_details" class="collapse show">
            <!--begin::Form-->
            <form action="{{ route("admin.footer-useful-links.update", $usefulLink->id) }}" method="POST" class="form fv-plugins-bootstrap5 fv-plugins-framework">
                @csrf
                @method('PUT')
                <!--begin::Card body-->
                    ...
                    <div class="row mb-6 offset-1">
                        ...
                        <div class="col-lg-8 fv-row fv-plugins-icon-container">
                            <input type="text"
                                   ...
                                   value="{{ old('name', isset($usefulLink) ? $usefulLink->name : "") }}"
                            >
                    ...
                    <div class="row mb-6 offset-1">
                        ...
                        <div class="col-lg-8 fv-row fv-plugins-icon-container">
                            <input type="text"
                                   ...
                                   value="{{ old('url', isset($usefulLink) ? $usefulLink->url : "") }}"
                            >
                            <div class="fv-plugins-message-container invalid-feedback"></div>
                        </div>
                        <!--end::Col-->
