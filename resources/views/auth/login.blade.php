                ...
                <form action="{{ route("login") }}" method="POST" class="form w-100">
                    ...
                    <div class="fv-row mb-5">
                        ...
                        <div class="d-flex flex-stack mb-2">
                            ...
                            <!--end::Label-->
                            <!--begin::Link-->
                            <a href="{{ route('password.request') }}" class="link-primary fs-6 fw-bolder">Şifreni mi Unuttun ?</a>
                            <!--end::Link-->
                        </div>
                        <!--end::Wrapper-->
                        <!--begin::Input-->
                        ...
                        <div class="fv-row mt-10">
                            <div class="d-flex flex-stack">
                                <label class="form-check form-check-custom form-check-solid ms-auto">
                                    ...
                                    <span class="link-primary fs-6 fw-bolder ms-2">Beni Hatırla</span>
                                </label>
                            </div>
                        </div>
                    ...
                    <div class="text-center">
                        ...
                        <button type="submit" id="kt_sign_in_submit" class="btn btn-lg btn-primary w-100 mb-5">
                            <span class="indicator-label">Oturum Aç</span>
                        ...
                        <a href="javascript:void(0)" class="btn btn-flex flex-center btn-light btn-lg w-100 mb-5">
                            <img alt="Logo" src="{{ asset("assets/assets/media/svg/brand-logos/google-icon.svg") }}" class="h-20px me-3" />Google İle Giriş
                        </a>
                        <!--end::Google link-->

                        <!--begin::Facebook link-->
                        <a href="javascript:void(0)" class="btn btn-flex flex-center btn-light btn-lg w-100 mb-5">
                            <img alt="Logo" src="{{ asset("assets/assets/media/svg/brand-logos/facebook-4.svg") }}" class="h-20px me-3" />Facebook İle Giriş
                        </a>
                        <!--end::Facebook link-->

                        <!--begin::Apple link-->
                        <a href="javascript:void(0)" class="btn btn-flex flex-center btn-light btn-lg w-100">
                            <img alt="Logo" src="{{ asset("assets/assets/media/svg/brand-logos/apple-black.svg") }}" class="h-20px me-3" />Apple Kimliği İle Giriş
                        </a>
                        <!--end::Apple link-->
                    </div>
                    <!--end::Actions-->
...
<script src="{{ asset("assets/assets/js/custom/authentication/sign-in/general.js") }}"></script>
