                ...
                <div class="col-sm-12">
                    ...
                    <div class="description">
                        ...
                        <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Autem porro ex repellat nobis
                            ...
                            ipsam.</p>
                        <ul class="gallery">
                            <li><img src="{{ asset("frontend/assets/images/gallery-1.jpg") }}" alt="" class="img-fluid w-100"></li>
                            <li><img src="{{ asset("frontend/assets/images/gallery-2.jpg") }}" alt="" class="img-fluid w-100"></li>
                        </ul>
                        <h3>Process Story</h3>
