            ...
            <div class="row portfolios">
                ...
                <div data-wow-delay="0.4s" class="col-md-6 col-lg-4 filter-item interface">
                    <div class="single-portfolio">
                        ...
                        <div class="portfolio-content">
                            <a href="{{ asset("frontend/assets/images/portfolio-2.jpg") }}" data-lity class="icon"><i
                                    class="fas fa-plus"></i></a>
                ...
                <div data-wow-delay="0.5s" class="col-md-6 col-lg-4 filter-item branding">
                    <div class="single-portfolio">
                        ...
                        <div class="portfolio-content">
                            <a href="{{ asset("frontend/assets/images/portfolio-3.jpg") }}" data-lity class="icon"><i
                                    class="fas fa-plus"></i></a>
                ...
                <div data-wow-delay="0.3s" class="col-md-6 col-lg-4 filter-item interface experience">
                    <div class="single-portfolio">
                        ...
                        <div class="portfolio-content">
                            <a href="{{ asset("frontend/assets/images/portfolio-4.jpg") }}" data-lity class="icon"><i
                                    class="fas fa-plus"></i></a>
                ...
                <div data-wow-delay="0.4s"
                    ...
                    <div class="single-portfolio">
                        ...
                        <div class="portfolio-content">
                            <a href="{{ asset("frontend/assets/images/portfolio-5.jpg") }}" data-lity class="icon"><i
                                    class="fas fa-plus"></i></a>
                ...
                <div data-wow-delay="0.5s" class="col-md-6 col-lg-4 filter-item interface">
                    <div class="single-portfolio">
                        ...
                        <div class="portfolio-content">
                            <a href="{{ asset("frontend/assets/images/portfolio-6.jpg") }}" data-lity class="icon"><i
                                    class="fas fa-plus"></i></a>
                ...
                <div data-wow-delay="0.3s" class="col-md-6 col-lg-4 filter-item development">
                    <div class="single-portfolio">
                        ...
                        <div class="portfolio-content">
                            <a href="{{ asset("frontend/assets/images/portfolio-7.jpg") }}" data-lity class="icon"><i
                                    class="fas fa-plus"></i></a>
                ...
                <div data-wow-delay="0.4s" class="col-md-6 col-lg-4 filter-item experience">
                    <div class="single-portfolio">
                        ...
                        <div class="portfolio-content">
                            <a href="{{ asset("frontend/assets/images/portfolio-8.jpg") }}" data-lity class="icon"><i
                                    class="fas fa-plus"></i></a>
                ...
                <div data-wow-delay="0.5s" class="col-md-6 col-lg-4 filter-item development">
                    <div class="single-portfolio">
                        ...
                        <div class="portfolio-content">
                            <a href="{{ asset("frontend/assets/images/portfolio-9.jpg") }}" data-lity class="icon"><i
                                    class="fas fa-plus"></i></a>
