                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item hidden-on-mobile">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end language-dropdown" aria-labelledby="languageDropDown">
                            <li><a class="dropdown-item" href="#"><img src="{{ asset('../../assets/images/flags/germany.png') }}" alt="">German</a></li>
                            <li><a class="dropdown-item" href="#"><img src="{{ asset('../../assets/images/flags/italy.png') }}" alt="">Italian</a></li>
                            <li><a class="dropdown-item" href="#"><img src="{{ asset('../../assets/images/flags/china.png') }}" alt="">Chinese</a></li>
                        </ul>
                    </li>
                    <li class="nav-item hidden-on-mobile">
